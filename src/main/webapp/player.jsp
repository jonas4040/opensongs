...
<jsp:useBean id="Usuario" class="org.opensongs.model.Usuario"
	scope="session" />
<jsp:useBean id="Playlist" type="org.opensongs.model.Playlist"
	scope="session" />
...
<style>
        ...
        <script type="text/javascript">
        	...
        	var URL = "http://"+hostname+"/opensongs/";
            var player;
            function setupPlayer() {
                ...
                document.getElementById("nowPlaying").innerHTML="Tocando agora:" + document.getElementById(musics[currentSong]).innerHTML;
            ...
            function changeRepeat() {
                repeat = !repeat;
                if (repeat) {
                    document.getElementById("imgRepeat").src = "img/repeat_green.png";
                } else {
                    document.getElementById("imgRepeat").src = "img/repeat_gray.png";
                }
            }
    ...
    <body onLoad="setupPlayer();">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="playlists"><img src="img/logo_opensongs.png" class="rounded mx-auto d-block" width="15%" align="center"/></a>
                    <img id="imgRepeat" src="img/repeat_gray.png" class="rounded mx-auto d-block" width="5%" onclick="changeRepeat();" align="center"/>
                </div>
            </div>
        </div>
        ...
        <div id="playerdiv">
            <div id="nowPlaying"> Tocando agora: </div>
