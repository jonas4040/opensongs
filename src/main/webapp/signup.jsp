...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-center">Fa&ccedil;a parte.</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="col-md-8">
						<form role="form" action="createuser" method="POST">
							<div class="form-group">
								...
								<label for="exampleInputName1"> Seu Nome </label> <input
							...
							<div class="form-group">
								...
								<label for="exampleInputEmail1"> Seu Email </label> <input
									type="email" class="form-control" id="exampleInputEmail1"
									name="txtEmail">
							</div>
							<div class="form-group">

								<label for="exampleInputPassword1"> Sua Senha </label> <input
